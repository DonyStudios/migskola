...
Revision ID: 0cc851ace3c1
Revises: 
Create Date: 2023-10-02 11:18:49.380358
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('vyrobce_vozidla', sa.String(length=150), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
